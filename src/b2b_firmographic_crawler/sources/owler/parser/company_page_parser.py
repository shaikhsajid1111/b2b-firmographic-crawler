...
class OwlerParser(Parser):
    ...
    def _map_status(self, status: str, ownership: str) -> CompanyStatus:
        ...
        if "subsidiary" in status_lower:
            return CompanyStatus.ACQUIRED
        elif "acquired" in status_lower:
            return CompanyStatus.ACQUIRED
        ...
        elif ownership_lower == "public" or ownership_lower == "private":
            return CompanyStatus.ACTIVE
        elif ownership_lower and ownership_lower != "":
            return CompanyStatus.ACTIVE
